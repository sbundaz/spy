...
for num_t in ("i8", "u8", "u32", "i32", "f32"):
    ...
    MM.register("-",  num_t, "f64", OP.w_f64_sub)
    MM.register("*",  "f64", num_t, OP.w_f64_mul)
    ...
    MM.register("!=", num_t, "f64", OP.w_f64_ne)
    MM.register("<" , "f64", num_t, OP.w_f64_lt)
    MM.register("<" , num_t, "f64", OP.w_f64_lt)
    MM.register("<=", "f64", num_t, OP.w_f64_le)
    MM.register("<=", num_t, "f64", OP.w_f64_le)
    MM.register(">" , "f64", num_t, OP.w_f64_gt)
...
MM.register_partial("-", "dynamic", OP.w_dynamic_sub)
MM.register_partial("*",  "dynamic", OP.w_dynamic_mul)
MM.register_partial("/",  "dynamic", OP.w_dynamic_div)
MM.register_partial("//", "dynamic", OP.w_dynamic_floordiv)
MM.register_partial("%",  "dynamic", OP.w_dynamic_mod)
MM.register_partial("<<", "dynamic", OP.w_dynamic_lshift)
MM.register_partial(">>", "dynamic", OP.w_dynamic_rshift)
MM.register_partial("&",  "dynamic", OP.w_dynamic_and)
MM.register_partial("|",  "dynamic", OP.w_dynamic_or)
MM.register_partial("^",  "dynamic", OP.w_dynamic_xor)
